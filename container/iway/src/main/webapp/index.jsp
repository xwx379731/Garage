...
<div class="position-relative js-header-wrapper ">
    <a href="https://github.com/#start-of-content" tabindex="1" class="px-2 py-4 show-on-focus js-skip-to-content">
        Skip to content
    </a>
            ...
            <div class="HeaderMenu HeaderMenu--bright d-lg-flex flex-justify-between flex-auto">
                <nav class="mt-3 mt-lg-0">
                    <ul class="d-lg-flex list-style-none">
                        <li class="ml-lg-2">
                            <a href="family" class="js-selected-navigation-item HeaderNavlink px-0 py-3 py-lg-2 m-0" data-ga-click="Header, click, Nav menu - item:features" data-selected-links="/features /features/project-management /features/code-review /features/project-management /features/integrations /features">
                                Family
                            </a>
                        </li>
                        <li class="ml-lg-4">
                            <a href="travel" class="js-selected-navigation-item HeaderNavlink px-0 py-3 py-lg-2 m-0" data-ga-click="Header, click, Nav menu - item:business" data-selected-links="/business /business/security /business/customers /business">
                                Travel
                            </a>
                        </li>
                        ...
                        <li class="ml-lg-4">
                            <a href="business" class="js-selected-navigation-item HeaderNavlink px-0 py-3 py-lg-2 m-0" data-ga-click="Header, click, Nav menu - item:marketplace" data-selected-links=" /marketplace">
                                Business
                            </a>
                        </li>
                        <li class="ml-lg-4">
                            <a href="explore" class="js-selected-navigation-item HeaderNavlink px-0 py-3 py-lg-2 m-0" data-ga-click="Header, click, Nav menu - item:pricing" data-selected-links="/pricing /pricing/developer /pricing/team /pricing/business-hosted /pricing/business-enterprise /pricing">
                                Explore
                            </a>
                        </li>
                    </ul>
                ...
                <div class="d-lg-flex">
                    <div class="d-lg-flex flex-items-center mr-lg-3">
                        <div class="header-search   js-site-search" role="search">
                            <form accept-charset="UTF-8" action="search" class="js-site-search-form" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="UTF-8"></div>
                            <label class="form-control header-search-wrapper js-chromeless-input-container">
                                <a href="https://github.com/dashboard" class="header-search-scope no-underline">/dashboard</a>
                                <input type="text" class="form-control header-search-input js-site-search-focus  " data-hotkey="s" name="q" value="" placeholder="Search" aria-label="Search" data-unscoped-placeholder="Search GitHub" data-scoped-placeholder="Search" autocapitalize="off">
        ...
        <div class="container-lg p-responsive position-relative">
            <div class="d-md-flex flex-items-center gutter-md-spacious">
                <div class="col-md-7 text-center text-md-left ">
                    <h1 class="alt-h0 text-white lh-condensed-ultra mb-3">A Platform for Lee Family </h1>
                ...
                <div class="mx-auto col-sm-8 col-md-5 hide-sm">
                    <div id="form" class="rounded-1 text-gray bg-gray-light py-4 px-4 px-md-3 px-lg-4">
                        ...
                        <dl class="form-group" style="display: none">
                            ...
                            <dd>
                                <input type="text" name="email" id="user[email]" class="form-control form-control-lg input-block js-email-notice-trigger" placeholder="you@example.com" data-autocheck-url="/signup_check/email" data-autocheck-authenticity-token="CTpT+yCJYkk3ayhKgXS0t3oKY/+pLksBV9GkPcfbZHqwbwBPdVRnum71BiDHYSaPGJvhoA5R6jKkjD7BeVyuaQ==">
                            </dd>
                        </dl>
                        <dl class="form-group">
                            <dt class="input-label">
                        ...
                        <input class="form-control" id="required_field_8f19" name="required_field_8f19" style="display: none" type="text">
    ...
    <div class="featurette">
        <div class="container-lg p-responsive pb-6">
            ...
            <p class="lead text-center col-md-8 mx-auto">
                Discuss together to work through problems, move ideas forward, and learn from each other along the way.
            </p>
